...
<body>
    ...
    <div class="wrapper">
        ...
        <br><br><br>
        <center>
            <form method="get" action="FileFilterServlet">
            ...
            <table border="1">
                ...
                <% while (rs.next()) { %>
                    <tr>
                        ...
                        <td><a href="DownloadServlet?fileName=<%= rs.getString("filename") %>">Download</a></td>
                        <td><a href="ViewServlet?fileName=<%= rs.getString("filename") %>">View</a></td>
                    </tr>
                    <% } %>
            </table>
            <% 
